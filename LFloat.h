#ifndef TBBLFLT_H  // LFloat.h ver 3.6.0
#define TBBLFLT_H
...
tbb::LFloat tbb::LFloat::operator-(const LFloat& B) const { return (*this) + (-B); }
tbb::LFloat tbb::LFloat::operator*(const LFloat& B) const {
	const LFloat& A = *this;
	// static int u= 0;
	// u++;	std::cerr<<u<<endl;
...
tbb::LFloat tbb::Div_LInt(LInt numerator, LInt denominator) { return LFloat(numerator) / LFloat(denominator); }

int tbb::LFloat::precision() { return tbb::_LFloat_prec; }
